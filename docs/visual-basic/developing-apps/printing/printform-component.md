...
---
# PrintForm Component (Visual Basic)
Le composant <xref:Microsoft.VisualBasic.PowerPacks.Printing.PrintForm> pour [!INCLUDE[vbprvb](../../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] vous permet d’imprimer une image d’un Windows Form au moment de l’exécution. Son comportement remplace celui de la méthode `PrintForm` dans les versions antérieures de Visual Basic.  
...
## Présentation du composant PrintForm  
...
### Méthodes, propriétés et événements principaux  
