...
Cette section explique comment effectuer les tâches associées à la lecture de fichiers.  
...
## Dans cette section  
 ...
 Montre comment lire un fichier texte délimité.  
  
 [How to: Read From Fixed\-width Text Files](../../../../visual-basic/developing-apps/programming/drives-directories-files/how-to-read-from-fixed-width-text-files.md)  
 Montre comment lire un fichier texte à largeur fixe.  
  
 [How to: Read From Text Files with Multiple Formats](../../../../visual-basic/developing-apps/programming/drives-directories-files/how-to-read-from-text-files-with-multiple-formats.md)  
 Montre comment lire un fichier texte avec plusieurs formats.  
...
## Rubriques connexes  
 ...
 Fournit une vue d'ensemble de la lecture de fichiers texte avec l'objet `TextFieldParser`.  
  
 [Walkthrough: Manipulating Files and Directories in Visual Basic](../../../../visual-basic/developing-apps/programming/drives-directories-files/walkthrough-manipulating-files-and-directories.md)  
 Montre comment utiliser la fonctionnalité `My` avec les fichiers et les répertoires.  
 ...
 Montre comment utiliser les méthodes du [!INCLUDE[dnprdnshort](../../../../csharp/getting-started/includes/dnprdnshort_md.md)] avec les fichiers et les répertoires.