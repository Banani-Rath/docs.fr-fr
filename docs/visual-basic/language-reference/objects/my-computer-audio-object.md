...
---
# My.Computer.Audio Object
Fournit des méthodes pour lire des sons.  
  
## Notes  
 Pour plus d'informations sur les méthodes et les propriétés de l'objet d' `My.Computer.Audio` , consultez l' <xref:Microsoft.VisualBasic.Devices.Audio>.  
