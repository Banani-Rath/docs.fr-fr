...
L'espace de noms `Microsoft.VisualBasic` contient les classes, les modules, les constantes et les énumérations qui constituent la bibliothèque Runtime [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)].  Ces membres de bibliothèque fournissent les procédures, les propriétés et les valeurs constantes que vous pouvez utiliser dans votre code.  Chaque module et chaque classe représentent une catégorie particulière de fonctionnalité.  
...
## Constantes et énumérations Microsoft.VisualBasic  
 L'espace de noms `Microsoft.VisualBasic` fournit des constantes et des énumérations en tant qu'éléments de la bibliothèque Runtime [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)].  Vous pouvez utiliser ces valeurs constantes dans votre code.  Chaque énumération représente une catégorie particulière de fonctionnalité.  Pour plus d'informations, consultez [Constants and Enumerations](../../visual-basic/language-reference/constants-and-enumerations.md).  
