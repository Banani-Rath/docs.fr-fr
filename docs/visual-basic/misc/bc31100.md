...
[Get Statement](../../visual-basic/language-reference/statements/get-statement.md) ou [Set Statement](../../visual-basic/language-reference/statements/set-statement.md) spécifie un niveau d’accès qui est moins restrictif que celui spécifié pour la propriété conteneur.  
