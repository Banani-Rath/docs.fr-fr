...
-   Si possible, utilisez des valeurs du même type de données, pour que [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] n’ait pas à effectuer de conversion.  
