...
Le nom d’un membre de type est en conflit avec le nom d’un membre implicitement déclaré dans toutes les énumérations.  
 ...
 Le compilateur [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] crée des membres implicites correspondant à certains éléments de programmation que vous déclarez. Les énumérations déclarent implicitement le membre `value__member`.  
