...
L’outil ALink, appelé par le compilateur [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)], signale une erreur lors de la génération de l’assembly. Les causes possibles sont les suivantes :  
