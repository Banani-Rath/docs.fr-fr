...
L’événement 'Class\_Initialize' n’est plus pris en charge. Utilisez 'Sub New' pour initialiser une classe.  
 ...
 L’événement `Class_Initialize` des versions précédentes de [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)] est remplacé par des constructeurs de classe.  
