---
title: "Impossible de lire les champs d&#233;limit&#233;s, car Delimiters a la valeur Nothing ou est vide | Microsoft Docs"
ms.custom: ""
ms.date: "11/16/2016"
...
`TextFieldParser` ne peut pas lire le fichier, car la propriété `Delimiters` a la valeur `Nothing` ou est vide.  
