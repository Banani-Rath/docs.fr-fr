...
Une liste de contraintes comprend à la fois la contrainte [New Operator](../../visual-basic/language-reference/operators/new-operator.md) et la contrainte [Structure \(Visual Basic\)](http://msdn.microsoft.com/fr-fr/263ce115-ac36-4c05-8cb7-0e0eead5c6d0).  
