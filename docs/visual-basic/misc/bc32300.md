...
Une erreur d’accès à un élément de code s’est produite dans le compilateur [!INCLUDE[vbprvb](../../csharp/programming-guide/concepts/linq/includes/vbprvb_md.md)].  
