...
'fonction' : impossible d'appeler explicitement un opérateur ou un accesseur  
 ...
 Certains opérateurs ont des noms internes.  Par exemple, **op\_Increment** est le nom interne de l'opérateur \+\+.  Vous ne devez pas utiliser ou appeler explicitement des noms de méthodes.  
