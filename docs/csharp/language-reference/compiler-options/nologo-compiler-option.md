...
L'option **\/nologo** supprime l'affichage de la bannière d'ouverture de session lorsque le compilateur démarre et affiche des messages d'information pendant la compilation.  
