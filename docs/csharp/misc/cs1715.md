...
'Type1': le type doit être 'Type2' pour correspondre au membre substitué 'nom\_membre'  
 ...
 Cette erreur est identique à [Erreur du compilateur CS0508](../../csharp/misc/cs0508.md), sauf que CS0508 s’applique maintenant uniquement aux méthodes qui ont des types de retour, alors que l’erreur CS1715 s’applique aux propriétés et aux indexeurs qui ont uniquement des « types » plutôt que des « types de retour ».  
