...
Impossible d’envoyer automatiquement le rapport d’erreur sans autorisation. Visitez '' pour autoriser l’envoi du rapports d’erreur.  
 ...
 Le site web indiqué dans le texte d’erreur explique comment activer les rapports d’erreurs automatiques pour les outils en ligne de commande [!INCLUDE[vsprvslong](../../csharp/misc/includes/vsprvslong_md.md)].  
