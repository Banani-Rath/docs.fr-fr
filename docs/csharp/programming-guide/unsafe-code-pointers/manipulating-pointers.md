---
title: "Manipulation de pointeurs (Guide de programmation C#) | Microsoft Docs"
ms.custom: ""
ms.date: "11/17/2016"
...
dev_langs: 
  - "CSharp"
helpviewer_keywords: 
  - "expressions de pointeur (C#), opérateurs"
  - "pointeurs (C#), manipulation"
...
Cette section traite des opérations relatives aux pointeurs suivantes :  
  
 [Incrémentation et décrémentation](../../../csharp/programming-guide/unsafe-code-pointers/how-to-increment-and-decrement-pointers.md)  
